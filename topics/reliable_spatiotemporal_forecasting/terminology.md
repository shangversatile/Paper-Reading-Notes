...
| polynomial graph filter | A polynomial graph filter constrains the spectral filter to be a polynomial of the graph Laplacian. This reduces parameter complexity and provides graph-hop localization in the node domain. | Candidate |
